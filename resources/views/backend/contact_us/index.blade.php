            ...
            <div class="card">
                ...
                <div class="card-body pt-6">
                    <div class="d-flex justify-content-between">
                        <button type="button" class="btn btn-danger" id="bulk_delete_btn" data-url="{{route('contact_us.bulk_delete')}}" data-title="contact us" disabled>Bulk Delete</button>
                        <!--begin::Search-->
                        <div class="d-flex align-items-center position-relative">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen021.svg-->
                            <span class="svg-icon svg-icon-1 position-absolute ms-6"><i class="fas fa-search"></i></span>
                            <!--end::Svg Icon-->
                            <form id="filter_form" action="{{ route('contact_us.index') }}" method="GET">
                    ...
                    <div id="load_content">
                        <!--begin::Table-->
                        @include('components.contact_us_table')
                        <!--end::Table-->
                    </div>
                </div>
                <!--end::Card body-->
