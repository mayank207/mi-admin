                ...
                <ul class="navbar-nav font-mulish-bold">
                    <li class="nav-item">
                        <a class="nav-link font-14 text-navy-blue"
                            href="#"><img src="{{asset('img/Arrow-left.png')}}"
            ...
            <div class="col-12 col-lg-9 mt-5">
                <button
                    ...
                    here to bring vocation and faith together in your church. <img src="{{asset('img/Arrow-blue.png')}}"
                        class="img-fluid ml-2" alt=""></button>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center mx-0">
            ...
            <div class="col-12 col-lg-6 text-center mt-4">
                <button class="btn btn-block btn-yellow rounded-pill font-20 font-mulish font-weight-bold py-3">Click
