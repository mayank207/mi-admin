<div class="toolbar">
    ...
    <div
        ...
        <div class="page-title d-flex flex-column me-5">
            <!--begin::Title-->
            <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">{{ $page_title }}</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                <!--begin::Item-->
                {!! setBreadCrumb('Home',route('backend.home'),1) !!}
                <!--end::Item-->
                @yield('title')
            </ul>
            <!--end::Breadcrumb-->
        ...
        <!--end::Page title-->
        <!--begin::Action group-->
        <div class="d-none align-items-center overflow-auto pt-3 pt-lg-0">
